...
import com.loginid.cryptodid.claimFetcher.creditscore.requests.ApiServiceTransUnion;
...
public class TransFormActivity extends AppCompatActivity {
    ...
    private ApiServiceTransUnion apiService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstName.setText("KATHY");
        lastName.setText("BETHEL");
        city.setText("MONROEVILLE");
        StreetName.setText("OLD CONCORD");
        StreetNum.setText("1240");
        PostalCode.setText("15146");
        TaxId.setText("666791984");
        ...
        btnGet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //your bearer token
                String bearerToken = "";
                final String CLIENT_ID = "8BtwPBcFW00X9cO2OigCBiDJArAkIVUU";
                final String CLIENT_SECRET = "pO6SVWztu95iziAh";
                ...
                apiService = retrofit.create(ApiServiceTransUnion.class);
    ...
    private void Check(String fullName,String score,String uid,String source) {
        ...
        if (fullName != ""  && score != "" && uid != "" && source != "") {
            ...
            intent.putExtra("attr", "creditScore");
