...
import com.learning.walletv21.presentation.navigation.drawer_navigation.NavigationBodyItems
...
fun BottomSheetNavigation(
    ...
    Row(modifier = Modifier.fillMaxWidth().background(MaterialTheme.colors.secondBackGroundColor).padding(15.dp)) {
